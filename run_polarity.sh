...
#train
python data/natural-instructions/src/client_dataset_split.py \
--import_tasks_file="/home/zx/nas/GitRepos/OpenFedLLM/config/natural_instruct/polarity/test_tasks.txt" \
--export_dir="/home/zx/nas/GitRepos/OpenFedLLM/data/natural-instructions/val" \
--max_per_task=1000 \
--num_clients=1 \
