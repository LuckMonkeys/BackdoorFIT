...
CUDA_VISIBLE_DEVICES=1 python main_sft_backdoor_superInstruct.py fed=fed_avg_small train=llama2_natural_instruction attack=badnet_classification attack.poison.triggers=cf attack.poison.num_triggers=4 train.max_steps=20 
